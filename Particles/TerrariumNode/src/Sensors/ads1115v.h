...
//======================================
// The Class
class ads1115v : public SensorBase
{
public:
...
private:
  ...
  Adafruit_ADS1115 ads = Adafruit_ADS1115(0x49);  /* Use this for the 16-bit version */
  //Adafruit_ADS1015 ads;     /* Use thi for the 12-bit version */
  double latestreading[nReadings] = {1.0,1.0,1.0,1.0};
  String JSONCodes[nReadings] = {String("A5"), String("A6"),String("A7"),String("A8")};
};
